...
class IncomeStatementTest {
    ...
    void setUp() {
        ...
        Car c1 = new Car(new String[]{enterString,"1",time,"_","_","78477000d3f4486557edd3245febeec0","#03b428","14",standardString,"Kombi","SU-B 26"}, new Standard(1));
        Car c2 = new Car(new String[]{enterString,"2",time,"_","_","f55fb9cbe110192e12c21dc734b6511c","#69524f","4",standardString,"SUV","SU-G 93"}, new Standard(2));
        Car c3 = new Car(new String[]{enterString,"3",time,"_","_","c8ed72e96795b1970367a5d058457ed9","#2a3e73","1",standardString,"Limousine","SU-A 14"}, new Standard(3));
        Car c4 = new Car(new String[]{enterString,"4",time,"_","_","c354d2014d1c63c9be162400be104894","#d6a3ea","18",standardString,"SUV","SU-J 99"}, new Standard(4));
        Car c5 = new Car(new String[]{enterString,"5",time,"_","_","d2227edd8ae39c18375039e14602afb4","#6c5d42","12",standardString,"SUV","SU-Q 66"}, new Standard(5));
