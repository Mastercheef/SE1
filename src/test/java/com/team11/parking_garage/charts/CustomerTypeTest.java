...
class CustomerTypeTest {
    ...
    @BeforeEach
    void setUp() {
    Car c1 = new Car(new String[]{ENTER,"1","1625744456000","_","_","78477000d3f4486557edd3245febeec0","#03b428","14","Standard","Kombi","SU-B 26"}, new Standard(1));
    Car c2 = new Car(new String[]{ENTER,"2","1625744457000","_","_","f55fb9cbe110192e12c21dc734b6511c","#69524f","4","Abonnent","SUV","SU-G 93"}, new Subscriber(2));
    Car c3 = new Car(new String[]{ENTER,"3","1625744458000","_","_","c8ed72e96795b1970367a5d058457ed9","#2a3e73","1", STUDENT,"Limousine","SU-A 14"}, new Discounted(3, STUDENT));
    Car c4 = new Car(new String[]{ENTER,"4","1625744459000","_","_","c354d2014d1c63c9be162400be104894","#d6a3ea","18","Senoir","SUV","SU-J 99"}, new Discounted(4,"Senior"));
    Car c5 = new Car(new String[]{ENTER,"5","1625744460000","_","_","d2227edd8ae39c18375039e14602afb4","#6c5d42","12","Familie","SUV","SU-Q 66"}, new Discounted(5, "Familie"));
